      ...
      <div className="movie_details w-300 h-150 bg-[#1A1823] rounded-lg flex items-center overflow-hidden">
        ...
        <div className="info relative h-full w-[65%] p-10">
          ...
          <div className="border-b border-secondary h-[90%] mb-5">
            ...
            <div className="my-5 flex items-center gap-10 text-secondary">
              <div className="flex items-center gap-5 font-bold text-accent">
                ...
                <p className="text-primary flex-center gap-1">
                  ...
                  <span className="text-secondary">{movie.rate.aggregaterate}</span>
                </p>
              </div>
              <div className="px-2 py-1 rounded-lg font-bold border border-secondary bg-foreground ">
                4K HDR
              </div>
            </div>
            ...
            <div className="desc">
              <h2 className="text-2xl font-extrabold bg-secodary mb-3">
                SYNOPSIS
              </h2>
              <p className="text-accent">{movie.plot}</p>
            </div>
            ...
            <div className="flex items-center justify-between mt-5 w-full">
              ...
              <div>
                ...
                <p className="text-secondary">{movie?.actors?.join(", ")}</p>
              </div>
            </div>
          </div>
          ...
          <div className="btn-details flex items-center justify-between">
            <div className="left_btn flex items-center gap-5">
              <button 
                className="bg-primary shadow-lg shadow-primary text-white outline-0 px-6 py-3 rounded-lg font-bold hover:bg-secondary hover:text-foreground shadow-sm transition-all duration-300 cursor-pointer"
            ...
            <div className="delete_details cursor-pointer">
              <p
                className="font-bold text-accent hover:text-red-300"
